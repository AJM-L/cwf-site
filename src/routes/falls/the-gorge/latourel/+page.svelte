					...
					<div class="w-full">
						...
						<div class="grid lg:grid-cols-3 gap-8 items-start">
							...
							<div class="lg:col-span-1 h-100">
								<img src={`${base}/images/waterfalls/optimized/latourell/5.webp`} alt="View of Latourell Falls from the trail" class="w-full h-100 object-cover rounded-lg shadow-lg" />
							</div>
							...
							<!-- Right Photo -->
							<div class="lg:col-span-1 h-100">
								<img src={`${base}/images/waterfalls/optimized/latourell/2.webp`} alt="Moss-covered basalt wall of Latourell Falls" class="w-full h-100 object-cover rounded-lg shadow-lg" />
							</div>
						</div>
						...
						<div class="grid md:grid-cols-3 gap-6 mt-8">
							<div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
								<img src={`${base}/images/waterfalls/optimized/latourell/1.webp`} alt="Water cascading down the falls" class="w-full h-full object-cover" />
							</div>
							<div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
								<img src={`${base}/images/waterfalls/optimized/latourell/3.webp`} alt="Trail and forest canopy" class="w-full h-full object-cover" />
							</div>
							<div class="aspect-[4/3] overflow-hidden rounded-lg shadow-lg">
								<img src={`${base}/images/waterfalls/optimized/latourell/6.webp`} alt="Mist and water at the base" class="w-full h-full object-cover" />
							</div>
						</div>
					</div>
				</div>
