...
<div class="max-w-7xl mx-auto px-4 py-8">
	...
	<section class="mb-12">
		<div class="relative overflow-hidden bg-white rounded-lg shadow-lg">
			<div class="p-4">
				<h3 class="text-xl font-semibold text-black mb-4 text-center">Cascade Range Map</h3>
				<p class="text-sm text-gray-600 mb-4 text-center">
					Landsat imagery showing the Cascade Range volcanoes and terrain features from Oregon to Washington
				</p>
			</div>
			<div class="relative overflow-hidden" id="map-container">
				<button 
					type="button"
					class="w-full border-0 p-0 bg-transparent cursor-zoom-in hover:opacity-95 transition-opacity"
			...
			<div class="p-4">
				<p class="text-xs text-gray-600 text-right">
					Credit: Oregon Historical Society - Cascade Range topographic map from Landsat imagery
				</p>
			</div>
		</div>
	</section>
		...
		<div class="bg-white p-4 lg:p-8">
			...
			<div class="max-w-5xl mx-auto space-y-6">
				<p class="text-gray-800 leading-relaxed">
					The Cascade Range extends roughly 1,300 km (800 miles) from northern California to southern British Columbia (Gardner et al., 2000). Its skyline is defined by the Cascade Volcanic Arc—a chain of active and dormant volcanoes produced by subduction of the Juan de Fuca, Gorda, and Explorer plates beneath North America (Brand et al., 2017). While the range includes uplifted and glaciated terrain beyond the young volcanic axis, the arc comprises major centers from Mount Baker and Glacier Peak in Washington through Mount Hood and Crater Lake (Mount Mazama) in Oregon to Mount Shasta, Medicine Lake, and Lassen Peak in California (USGS, 2023).
				</p>
				<p class="text-gray-800 leading-relaxed">
					Most Cascade stratovolcanoes erupt andesite–dacite magmas and commonly experience dome growth and collapses that can generate pyroclastic flows and lahars (Brand et al., 2017). Pleistocene–Holocene glaciation carved cirques and U-shaped valleys along the crest, producing today's alpine landforms. The late-Holocene caldera-forming eruption of Mount Mazama (~7.7 ka) created Crater Lake (Crandell, 1980), while shield-style edifices such as Medicine Lake Volcano illustrate compositional and eruptive diversity within the arc.
				</p>
			</div>
		</div>
	</section>
				...
				<div class="grid md:grid-cols-2 gap-8 items-center">
					<div>
						<p class="text-gray-800 leading-relaxed mb-6">
							Mount Hood (Oregon's highest peak) is a glacier-clad stratovolcano ~80 km east of Portland (Gardner et al., 2000). Volcanism at Hood spans ~500,000 years, with two prominent late-Holocene eruptive episodes—the Timberline (~1.5 ka) and Old Maid (late 18th–early 19th century)—dominated by lava-dome growth and collapse, generating pyroclastic flows and lahars, especially into the Sandy and White River valleys (Crandell, 1980; Brand et al., 2017).
						</p>
						<p class="text-gray-800 leading-relaxed mb-6">
							Regionally, Hood sits within the High Cascades volcanic belt (Brand et al., 2017). Older Western Cascades rocks and Columbia River Basalt underlie much of the surrounding terrain, while High Cascades volcanism built Hood's modern andesite–dacite cone and its volcaniclastic aprons. Lahars and debris flows have repeatedly reworked these deposits, shaping valley floors and flood hazards (Gardner et al., 2000).
						</p>
						<p class="text-gray-800 leading-relaxed">
							The peak's perennial ice and snow mantle (about 13.5 km²) includes glaciers such as Eliot and Coe (each ~2.5–3 km long) (USGS, 2023); however, recent studies document rapid 21st-century glacial retreat (Bakken-French et al., 2024). Summer meltwater sustains downstream flows critical to agriculture (e.g., Hood River Valley) and fish habitat (Halofsky et al., 2022).
						</p>
					</div>
		...
		<div class="bg-white p-4 lg:p-8">
			...
			<div class="max-w-5xl mx-auto">
				<p class="text-lg text-gray-800 leading-relaxed">
					Orographic uplift wrings Pacific moisture from westerly storms, creating a sharp west–east gradient: cool, wet conditions on windward flanks transition to a drier rain shadow east of the crest (Halofsky et al., 2022). Across elevations and aspects, the Mount Hood area spans EPA Level III Cascades ecoregions—from low-montane conifer forests through upper-montane belts into subalpine parklands and alpine barrens (EPA, 2025).
				</p>
			</div>
		</div>
	</section>
		...
		<div class="bg-white p-4 lg:p-8">
			...
			<div class="max-w-5xl mx-auto">
				<div class="grid md:grid-cols-2 gap-8 items-center">
					<div>
						<p class="text-gray-800 leading-relaxed mb-6">
							Late-successional and old-growth forests support the <strong>northern spotted owl</strong> (<em>Strix occidentalis caurina</em>, threatened), which typically uses structurally complex stands with multilayered canopies, large trees/snags, and abundant coarse woody debris (USFWS, 2024). The broader forested landscape supports Roosevelt elk, black-tailed deer, black bear, cougar, American marten, and diverse amphibian and bird assemblages (Halofsky et al., 2022).
						</p>
						<p class="text-gray-800 leading-relaxed">
							Cold, clean tributaries support salmonids (e.g., Chinook, coho, steelhead) alongside Pacific lamprey and native trout (Halofsky et al., 2022).
						</p>
					</div>
					<div class="flex flex-col items-center">
				...
				<div class="grid md:grid-cols-2 gap-8 items-center">
					<div>
						<p class="text-lg text-gray-800 leading-relaxed mb-6">
							Radial drainage from Mount Hood feeds major Columbia tributaries: the <strong>Sandy River</strong> (NW), <strong>Hood River</strong> (N), <strong>Clackamas River</strong> (SW), and the <strong>White River</strong> (SE) (USGS, 2023). The White River is a designated component of the National Wild and Scenic Rivers System for nearly its entire length (Rivers.gov, n.d.). Summer baseflows are dominated by snowpack and glacier melt; in basins such as the Hood River, late-season flows rely on Mount Hood's glacial inputs (Halofsky et al., 2022).
						</p>
					</div>
					<div class="flex flex-col items-center">
		...
		<div class="bg-white p-4 lg:p-8">
			...
			<div class="max-w-5xl mx-auto">
				<ul class="list-disc list-inside space-y-2 text-gray-800">
					<li><strong>Glaciers & snowfields:</strong> Eliot, Coe, Ladd, Sandy, Reid, Zigzag, Palmer (snowfield), White River, Newton Clark, Langille, Glisan, Coalman, among others, with active proglacial streams and evolving depositional plains (USGS, 2023).</li>
					<li><strong>Volcanic edifices & deposits:</strong> Crater Rock (Old Maid dome remnant), steep headwalls (Steel Cliff), lahar and debris-avalanche surfaces along Sandy and White rivers, and lava-dominated ridges such as Langille Crags (Brand et al., 2017; Gardner et al., 2000).</li>
					<li><strong>Protected areas:</strong> Mount Hood National Forest (including Mount Hood, Badger Creek, Salmon-Huckleberry, Mark O. Hatfield, and Roaring River wilderness areas) and the adjacent Columbia River Gorge National Scenic Area (Halofsky et al., 2022).</li>
				</ul>
			</div>
		</div>
	</section>
	...
	<section class="mb-12" id="concerns">
		<div class="text-center mb-8">
			...
			<p class="text-lg text-gray-800 max-w-3xl mx-auto">
				The Cascade region faces mounting environmental challenges linked to climate change, land use pressures, and biodiversity loss, including rapid glacier retreat (Bakken-French et al., 2024), shifting snowpack timing, increased wildfire severity, and habitat fragmentation by roads, dams, and urban expansion (Halofsky et al., 2022).
			</p>
		</div>
...
<style>
	/* Fullscreen styles for topographic map */
	...
	#map-container.fullscreen button {
